...
(defface visible-whitespace
  '((((background dark)) :foreground "grey40" :bold t)
    (((background light)) :foreground "grey70" :bold t))
...
(add-hook 'c++-mode-hook 'visible-whitespace-mode)
(add-hook 'java-mode-hook 'visible-whitespace-mode)
(add-hook 'python-mode-hook 'visible-whitespace-mode)
(add-hook 'c-mode-hook 'visible-whitespace-mode)
